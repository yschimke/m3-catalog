 ...
 * pinning one to a screen would frame it in a canvas it does not fill. The Wear generator this is
 * ported from needs a device for its full-screen samples; nothing here fills a phone screen by design.
 */
