...
the page has. [#437](https://github.com/yschimke/m3-catalog/issues/437) records the failure mode:
screen-blended content can nearly vanish when its authored background is pruned.
